 ...
 * @description Contains many re-usable plugin emssage constants.
...
export const cresolvedConstantsPath_PluginCommandIs = plg_sys.cresolvedConstantsPath_Plugin + wrd.cCommand + sys.cSpaceIsColonSpace; // resolvedConstantsPath_PluginComand is:
...
export const cPluginSystemConstantsPhase1Validation = wrd.cPlugin + bas.cSpace + wrd.cSystem + bas.cSpace + wrd.cConstants + bas.cSpace + wrd.cPhase + bas.cSpace + num.c1 + bas.cSpace + wrd.cValidation; // Plugin System Constants Phase1 Validation
